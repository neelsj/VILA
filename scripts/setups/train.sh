...
NNODES=1 #${SLURM_JOB_NUM_NODES:-1}
echo "NNODES = $NNODES"

NODES="localhost" #$(scontrol show hostnames "$SLURM_JOB_NODELIST" | tr '\n' ' ')
echo "NODES = $NODES"

NODE_RANK=0 #${SLURM_PROCID:-0}
...
MASTER_ADDR=$DEFAULT_MASTER_ADDR #${MASTER_ADDR:-$DEFAULT_MASTER_ADDR}
